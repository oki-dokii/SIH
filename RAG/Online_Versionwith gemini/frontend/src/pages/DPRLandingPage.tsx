                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-sm opacity-60">
                                <li><a href="https://india.gov.in/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">India.gov.in</a></li>
                                <li><a href="https://www.digitalindiaportal.co.in/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">Digital India</a></li>
                                <li><a href="https://www.mygov.in/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">MyGov.in</a></li>
                                <li><a href="https://www.data.gov.in/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">Open Data Portal</a></li>
                                <li><a href="https://beneficiary.nha.gov.in/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">Beneficiary NHA</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-sm opacity-60">
                                <li><a href="https://mdoner.gov.in/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">MDoNER Official</a></li>
                                <li><a href="https://necouncil.gov.in/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">NE Council</a></li>
                                <li><a href="https://www.nedfi.com/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">NEDFI</a></li>
                                <li><a href="https://mdoner.gov.in/activities/nlcpr-background" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">NLCPR</a></li>
                                <li><a href="https://www.meity.gov.in/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500 transition-colors">MEITY</a></li>
                            </ul>
                        </div>
                    </div>
